class TransacaosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to transacaos_path, status: :see_other, notice: "Transacao was successfully destroyed." }
  ...
  private
    ...
    def set_transacao
      @transacao = Transacao.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def transacao_params
      params.expect(transacao: [ :tipo, :descricao, :valor ])
    end
end
